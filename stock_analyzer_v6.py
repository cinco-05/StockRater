...
Run:
    ...
    python stock_analyzer_v6.py --ticker AAPL --peers MSFT,GOOGL --detail detailed
    python stock_analyzer_v6.py --ticker AAPL --json
    python stock_analyzer_v6.py --mos 0.30 --ticker AAPL
    python stock_analyzer_v6.py --self-test
    python stock_analyzer_v6.py --backtest-csv history.csv
